...
public class MudanzaVehiculoController {
    ...
    @PostMapping("/save")
    public String save(@RequestParam Long mudanzaId,
                       @RequestParam Long vehiculoId,
                       @RequestParam double pesoMudanza,
                       @RequestParam(required = false) String observaciones) {
        mudanzaVehiculoService.asignarVehiculo(mudanzaId, vehiculoId, pesoMudanza, observaciones);
